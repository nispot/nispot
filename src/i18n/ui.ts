...
export const ui = {
  en: {
    ...
    'ai.subtitle': 'I define the intention. AI executes the vision.',
    'ai.human_label': 'HUMAN',
    'ai.ai_label': 'AI',
    'ai.human_intent': 'Intent',
    'ai.human_vision': 'Vision',
    'ai.human_strategy': 'Strategy',
    'ai.ai_execution': 'Execution',
    'ai.ai_output': 'Output',
    'ai.ai_scale': 'Scale',
    ...
    'ai.tools_description': 'From Cursor-powered coding to agentic skill workflows.',
  ...
  es: {
    ...
    'ai.subtitle': 'Yo defino la intención. La IA ejecuta la visión.',
    'ai.human_label': 'HUMANO',
    'ai.ai_label': 'IA',
    'ai.human_intent': 'Intención',
    'ai.human_vision': 'Visión',
    'ai.human_strategy': 'Estrategia',
    'ai.ai_execution': 'Ejecución',
    'ai.ai_output': 'Resultado',
    'ai.ai_scale': 'Escala',
    ...
    'ai.tools_description':
      'Del código con Cursor a flujos de habilidades con agentes.',
    'ai.tools_cursor': 'Cursor',
